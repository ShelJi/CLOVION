...
class SignUpView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            messages.success(request,"failed to account created")
            return render(request,"register.html",{"form":form})
...
class TaskCreateView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            messages.error(request,"task added error")
            return render(request,"task-add.html",{"form":form})
@method_decorator(signin_required,name="dispatch")      
...
# localhost:8000/tasks/details/1
@method_decorator(signin_required,name="dispatch")      
class TaskDetailView(View):
    def get(self,request,*args,**kwargs):
        id=kwargs.get("id")
        qs=Tasks.objects.get(id=id)
        messages.success(request,"task details")
...
class TaskEditView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            messages.error(request,"task edit error")
            return render(request,"task-edit.html",{"form":form})
@method_decorator(signin_required,name="dispatch")              
